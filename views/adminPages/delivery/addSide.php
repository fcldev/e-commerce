...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="/Ecommerce/index.php/confirmAddSide">
                <div class="card-body">
                    <div class="form-group">
                        <label for="side">Side Name</label>
                        <input type="text" class="form-control" name="side" id="side" placeholder="Side name">
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="price">Delivery price</label>
                        <input type="text" class="form-control" name="price" id="price" placeholder="Side delivery price">
                    </div>
                </div>
                <!-- /.card-body -->
