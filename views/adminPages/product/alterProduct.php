...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-primary mx-5">
        ...
        <h3 class="card-title">Alter product informations</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form class="row" method="post" action="/Ecommerce/index.php/confirmAlterProduct?id_product=<?php echo $product1['id_product']; ?>" enctype="multipart/form-data">
        <div class="card-body col-lg-6 col-sm-12">
            <div class="form-group">
                <label for="name">Name</label>
                <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?php echo $product1['name']; ?>">
            </div>
            <div class="form-group">
                <label for="description">Description</label>
                <input type="text" class="form-control" name="description" id="description" placeholder="Description" value="<?php echo $product1['description']; ?>">
            </div>
            <div class="form-group">
                <label for="tags">Tags</label>
                <input type="text" class="form-control" name="tags" id="tags" placeholder="Tags" value="<?php echo $product1['tags']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="date_arrivale" id="dateArrivale" placeholder="Date arrival" value="<?php echo $product1['date_arrivale']; ?>">
            </div>
            <div class="form-group">
                <label for="sizes">Sizes available</label>
                <input type="text" class="form-control" name="sizes_available" id="sizes" placeholder="Sizes available" value="<?php echo $product1['sizes_available']; ?>">
            </div>
        </div>
        <div class="card-body col-lg-6 col-sm-12">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="video" id="videoLink" placeholder="Video link" value="<?php echo $product1['video']; ?>">
            </div>
            <div class="form-group">
                <label for="quantity">Quantity</label>
                <input type="number" class="form-control" name="quantity" id="quantity" placeholder="Quantity" value="<?php echo $product1['quantity']; ?>">
            </div>
            <div class="form-group">
                <label for="discount">Discount</label>
                <input type="number" class="form-control" name="discount" id="discount" placeholder="Discount" value="<?php echo $product1['discount']; ?>">
            </div>
            <div class="form-group">
